...
import { FaHome, FaChartPie, FaEnvelope, FaComments, FaCalendar, FaColumns, FaReceipt, FaRobot, FaExclamationCircle } from "react-icons/fa";
  ...
  return (
    <section className={mobileMenu ? "overlay active" : "overlay "}>
      ...
      >
        ...
        <div>
          <Link to='/' className='sidebar-logo skribrie-logo'>
        ...
        <div className='sidebar-menu-area'>
          <ul className='sidebar-menu' id='sidebar-menu'>
            ...
            <li>
              ...
              >
                <FaEnvelope size={24} className='menu-icon' />
                <span>Email</span>
              </NavLink>
            </li>
            <li>
              <NavLink
                ...
                className={(navData) => (navData.isActive ? "active-page" : "")}
              >
                <FaComments size={24} className='menu-icon' />
                <span>Chat</span>
              </NavLink>
            </li>
            <li>
              <NavLink
                ...
                className={(navData) => (navData.isActive ? "active-page" : "")}
              >
                <FaCalendar size={24} className='menu-icon' />
                <span>Calendar</span>
              </NavLink>
            </li>
            <li>
            ...
            <li className='dropdown'>
              <Link to='#'>
                <FaReceipt size={24} className='menu-icon' />
                <span>Invoice</span>
              </Link>
              <ul className='sidebar-submenu'>
                <li>
            ...
            <li className='dropdown'>
              <Link to='#'>
                <FaRobot size={24} className='menu-icon' />
      ...
      >
              ...
              <div className='d-flex flex-wrap align-items-center gap-3'>
                    ...
                    <div className='max-h-400-px overflow-y-auto scroll-sm pe-4'>
                      ...
                      >
                        <div className='text-black hover-bg-transparent hover-text-primary d-flex align-items-center gap-3'>
                          <div className="profile-avatar kavita-mehra pattern-1 flex-shrink-0">
                            KM
                      ...
                      >
                        <div className='text-black hover-bg-transparent hover-text-primary d-flex align-items-center gap-3'>
                          <div className="profile-avatar sanjay-kapoor pattern-2 flex-shrink-0">
                            SK
                      ...
                      >
                        <div className='text-black hover-bg-transparent hover-text-primary d-flex align-items-center gap-3'>
                          <div className="profile-avatar pooja-singh pattern-3 flex-shrink-0">
                            PS
                            <span className="status-indicator status-online"></span>
                          </div>
                          <div>
                      ...
                      >
                        <div className='text-black hover-bg-transparent hover-text-primary d-flex align-items-center gap-3'>
                          <div className="profile-avatar aryan-joshi pattern-4 flex-shrink-0">
                            AJ
                            <span className="status-indicator status-offline"></span>
                          </div>
                          <div>
                      ...
                      >
                        <div className='text-black hover-bg-transparent hover-text-primary d-flex align-items-center gap-3'>
                          <div className="profile-avatar nisha-patel pattern-5 flex-shrink-0">
                            NP
                            <span className="status-indicator status-online"></span>
                          </div>
                          <div>
                ...
                <div className='dropdown'>
                  ...
                  <div className='dropdown-menu to-top dropdown-menu-lg p-0'>
                    ...
                    <div className='max-h-400-px overflow-y-auto scroll-sm pe-4'>
                      ...
                      >
                        <div className='text-black hover-bg-transparent hover-text-primary d-flex align-items-center gap-3'>
                          <div className="profile-avatar ravi-malhotra pattern-2 flex-shrink-0">
                            RM
                            <span className="status-indicator status-online"></span>
                          </div>
                          <div>
                      ...
                      >
                        <div className='text-black hover-bg-transparent hover-text-primary d-flex align-items-center gap-3'>
                          <div className="profile-avatar anjali-mishra pattern-3 flex-shrink-0">
                            AM
                      ...
                      >
                        <div className='text-black hover-bg-transparent hover-text-primary d-flex align-items-center gap-3'>
                          <div className="profile-avatar aishwarya-reddy pattern-4 flex-shrink-0">
                            AR
                            <span className="status-indicator status-online"></span>
                          </div>
                          <div>
                      ...
                      >
                        <div className='text-black hover-bg-transparent hover-text-primary d-flex align-items-center gap-3'>
                          <div className="profile-avatar deepak-verma pattern-5 flex-shrink-0">
                            DV
                ...
                <div className='dropdown'>
                  <button
                    ...
                    data-bs-toggle='dropdown'
                  >
                    <div className="profile-avatar large rajesh-kumar pattern-1 hover-effect with-border" title="Skribrie">
                      SK
                      <span className="status-indicator status-online"></span>
        ...
        <footer className='d-footer'>
          <div className='row align-items-center justify-content-between'>
            ...
            <div className='col-auto'>
              <p className='mb-0'>
                Made with <span className='text-primary-600'>❤️</span>
              </p>
            </div>
          </div>
        </footer>
