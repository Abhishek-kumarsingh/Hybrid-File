            ...
            <div className='d-flex align-items-start justify-content-between gap-2'>
              <div className='d-flex align-items-center gap-12 flex-wrap'>
                ...
                <div className='d-flex flex-column flex-grow-1'>
                  <h6 className='text-xl mb-0'>Krish Verma</h6>
          ...
          <div className='card-body p-24'>
            <div className='d-flex align-items-start justify-content-between gap-2'>
              <div className='d-flex align-items-center gap-12 flex-wrap'>
                ...
                <div className='d-flex flex-column flex-grow-1'>
                  <h6 className='text-xl mb-0'>Lakshya Agarwal</h6>
          ...
          <div className='card-body p-24'>
            <div className='d-flex align-items-start justify-content-between gap-2'>
              <div className='d-flex align-items-center gap-12 flex-wrap'>
                ...
                <div className='d-flex flex-column flex-grow-1'>
                  <h6 className='text-xl mb-0'>Manav Khanna</h6>
          ...
          <div className='card-body p-24'>
            <div className='d-flex align-items-start justify-content-between gap-2'>
              <div className='d-flex align-items-center gap-12 flex-wrap'>
                ...
                <div className='d-flex flex-column flex-grow-1'>
                  <h6 className='text-xl mb-0'>Nandini Reddy</h6>
          ...
          <div className='card-body p-24'>
            <div className='d-flex align-items-start justify-content-between gap-2'>
              <div className='d-flex align-items-center gap-12 flex-wrap'>
                ...
                <div className='d-flex flex-column flex-grow-1'>
                  <h6 className='text-xl mb-0'>Ojasvi Sharma </h6>
          ...
          <div className='card-body p-24'>
            <div className='d-flex align-items-start justify-content-between gap-2'>
              <div className='d-flex align-items-center gap-12 flex-wrap'>
                ...
                <div className='d-flex flex-column flex-grow-1'>
                  <h6 className='text-xl mb-0'>Pranav Desai </h6>
          ...
          <div className='card-body p-24'>
            <div className='d-flex align-items-start justify-content-between gap-2'>
              <div className='d-flex align-items-center gap-12 flex-wrap'>
                ...
                <div className='d-flex flex-column flex-grow-1'>
                  <h6 className='text-xl mb-0'>Rahul Kapoor</h6>
          ...
          <div className='card-body p-24'>
            <div className='d-flex align-items-start justify-content-between gap-2'>
              <div className='d-flex align-items-center gap-12 flex-wrap'>
                ...
                <div className='d-flex flex-column flex-grow-1'>
                  <h6 className='text-xl mb-0'>Rishi Malhotra</h6>
          ...
          <div className='card-body p-24'>
            <div className='d-flex align-items-start justify-content-between gap-2'>
              <div className='d-flex align-items-center gap-12 flex-wrap'>
                ...
                <div className='d-flex flex-column flex-grow-1'>
                  <h6 className='text-xl mb-0'>Samar Choudhary</h6>
                  <span className='text-neutral-500'>Back End Developer</span>
                </div>
              </div>
              <ul className='d-flex align-items-center justify-content-end gap-1'>
