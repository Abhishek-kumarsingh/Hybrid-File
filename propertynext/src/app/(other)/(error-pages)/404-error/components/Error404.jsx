                    ...
                    <div className="p-4">
                      <div className="mx-auto mb-4 text-center">
                        <div className="mx-auto text-center auth-logo">
                          <Link href="/dashboards/property" className="logo-dark">
                            <Image src={logoDark} height={32} alt="logo dark" />
                          </Link>
                          <Link href="/dashboards/property" className="logo-light">
                        ...
                        <div className="text-center">
                          <Link href="/dashboards/property" className="btn btn-danger">
                            Back to Home
                          </Link>
                        </div>
                      </div>
