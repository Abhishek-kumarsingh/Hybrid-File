                                ...
                                <div className="fr-grid-thumb mx-auto text-center mt-5 mb-3">
                                    <Link href="/agent-page" className="d-inline-flex p-1 circle border">
                                        {item.image ? (
                                            ...
                                            <div
                                                className={`d-flex align-items-center justify-content-center text-white circle ${item.bgColor || 'bg-primary'}`}
                                                style={{ width: '130px', height: '130px', fontSize: '2.5rem', fontWeight: 'bold' }}
                                            >
                                                {item.initials || item.name.split(' ').map((n: string) => n[0]).join('')}
                                            </div>
                                        )}
                                    </Link>
                                </div>
