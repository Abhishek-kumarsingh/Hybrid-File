                ...
                <div className="col-xl-3 col-lg-3 col-md-4 col-sm-6" key={index}>
                    <div className="location-property-wrap rounded-4 p-2">
                        <div className="location-property-thumb rounded-4">
                            <Link href="/listings-list-with-sidebar">
                                {item.image ? (
                                    <Image src={item.image} width={0} height={0} sizes='100vw' style={{width:'100%', height:'auto'}} className="img-fluid" alt="" />
                                ) : (
                                    <div
                                        className="d-flex align-items-center justify-content-center text-white rounded-4"
                                        style={{
                                    ...
                                    >
                                        <div className="text-center">
                                            <i className={`${item.icon || 'fa-solid fa-city'} fs-1 mb-2`}></i>
                                            <h6 className="text-white mb-0">{item.location.split(',')[0]}</h6>
                                        </div>
                                    </div>
                                )}
                            </Link>
