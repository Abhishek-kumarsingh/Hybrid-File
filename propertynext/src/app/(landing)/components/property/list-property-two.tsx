            ...
            <div className="footer-first">
              <div className="listing-features-info">
                <ul className="featur_5269">
                  <li>
                    <div className="ft_th">
                      <i className="fa-solid fa-dog text-muted-2"></i>
                    </div>
                  </li>
                  <li>
                    <div className="ft_th">
                      <i className="fa-solid fa-snowflake text-muted-2"></i>
                    </div>
                  </li>
                  <li>
                    <div className="ft_th">
                      <i className="fa-solid fa-wifi text-muted-2"></i>
                    </div>
                  </li>
                  <li>
                    <div className="ft_th">
                      <i className="fa-solid fa-dumbbell text-muted-2"></i>
                    </div>
                  </li>
                  <li>
                    <div className="ft_th">
                      <i className="fa-solid fa-car text-muted-2"></i>
                    </div>
                  </li>
                </ul>
              </div>
                      ...
                      <div className="col-lg-12 col-md-12">
                        <div className="form-group">
                          ...
                          <textarea className="form-control ht-120">
                            I'm interested in 5689 Resot Relly, Canada. Please send me current availability and additional details.
                          </textarea>
                        </div>
                      </div>
