  ...
  theme: {
    ...
    extend: {
      colors: {
        ...
        dda: {
          DEFAULT: "#006838", // DDA primary green
          light: "#4C9A74",
          dark: "#004D2A",
          accent: "#F7941D", // Orange accent
          secondary: "#0072BC", // Blue secondary
          tertiary: "#8CC63F", // Light green
          gray: "#58595B",
          lightgray: "#D1D3D4",
        },
        blue: {
      ...
      borderRadius: {
       ...
       boxShadow: {
        ...
        'colored-lg': '0 10px 15px -3px var(--shadow-color, rgba(0, 0, 0, 0.1)), 0 4px 6px -2px var(--shadow-color, rgba(0, 0, 0, 0.05))',
      },
      keyframes: {
        "accordion-down": {
          from: { height: "0" },
        ...
        // New animations for modern design
        "gradient-x": {
          "0%, 100%": {
    ...
    extend: {
      ...
      animation: {
        ...
        "slide-left-fade": "slide-left-fade 0.3s ease-out",
