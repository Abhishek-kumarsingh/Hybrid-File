...
export default function Navbar({transparent}:{transparent:any}) {
  ...
  return (
    <>
        {/* Static transparent navbar - only visible when not scrolled */}
                ...
                <nav id="navigation " className={windowWidth > 991 ? "navigation navigation-landscape" : "navigation navigation-portrait"}>
                    <div className="nav-header" style={{lineHeight:'0'}}>
                        <Link className="nav-brand text-logo" href="#">
                            <Image src='/img/logo-new.svg' width={50} height={50} alt="" />
                            <h5 className="fs-3 fw-bold ms-1 my-0" style={{color: 'white', textShadow: '1px 1px 3px rgba(0,0,0,0.5)'}}>HomeVista</h5>
                        </Link>
                    ...
                    <div className={`nav-menus-wrapper  ${toggle ? 'nav-menus-wrapper-open' : ''}`} style={{transitionProperty:toggle ? 'none' : 'left'}}>
                        ...
                        <ul className="nav-menu" style={{color: 'white', fontWeight: 'bold'}}>
                            <li className={`${['/','/video','/map'].includes(current) ? 'active' : ''}`}>
                                <Link href="/" style={{color: 'white', fontWeight: 'bold', textShadow: '1px 1px 3px rgba(0,0,0,0.5)'}}>Home</Link>
                            </li>
                            <li className={` ${['/list-layout-one','/list-layout-two','/list-layout-three','/list-layout-with-map','/list-layout-full','/list-layout-one','/list-layout-two','/list-layout-three','/list-layout-with-map','/list-layout-full','/grid-layout-with-sidebar','/classical-layout-with-sidebar','/grid-layout-with-map','/grid','/classical-property','/list-layout-with-map','/grid-layout-with-map','/classical-layout-with-map','/half-map','/half-map-2'].includes(current) ? 'active' : ''} ${activeMenu['listing']?.main ? 'show' : ''}`} onMouseEnter={() => handleMouseEnter('listing')} onMouseLeave={() => handleMouseLeave('listing')}>
                                <Link href="#" onClick={(e) => e.preventDefault()} style={{color: 'white', fontWeight: 'bold', textShadow: '1px 1px 3px rgba(0,0,0,0.5)'}}>Listings<FiChevronDown className="submenu-indicator"/></Link>
                                <ul className="nav-dropdown nav-submenu" style={{display: activeMenu['listing']?.main ? 'block' : 'none', pointerEvents: activeMenu['listing']?.main ? 'auto' : 'none', backgroundColor: 'white', boxShadow: '0 5px 30px rgba(0, 22, 84, 0.1)'}}>
                                    <li className={`${['/list-layout-one','/list-layout-two','/list-layout-three','/list-layout-with-map','/list-layout-full'].includes(current) ? 'active' : ''}`} onMouseEnter={() => handleMouseEnter('listing', 'list-layout')} onMouseLeave={() => handleMouseLeave('listing', 'list-layout')}><Link href="#" onClick={(e) => e.preventDefault()} style={{color: '#333'}}>List Layout<FiChevronDown className="submenu-indicator"/></Link>
                                        <ul className="nav-dropdown nav-submenu" style={{display: activeMenu['listing']?.['list-layout'] ? 'block' : 'none',pointerEvents: activeMenu['listing']?.['list-layout'] ? 'auto' : 'none', backgroundColor: 'white', boxShadow: '0 5px 30px rgba(0, 22, 84, 0.1)'}}>
                                    ...
                                    <li className={`${['/grid-layout-with-sidebar','/classical-layout-with-sidebar','/grid-layout-with-map','/grid','/classical-property'].includes(current) ? 'active' : ''}`} onMouseEnter={() => handleMouseEnter('listing', 'grid-layout')} onMouseLeave={() => handleMouseLeave('listing', 'grid-layout')}><Link href="#" onClick={(e) => e.preventDefault()} style={{color: '#333'}}>Grid Layout<FiChevronDown className="submenu-indicator"/></Link>
                                        <ul className="nav-dropdown nav-submenu" style={{display: activeMenu['listing']?.['grid-layout'] ? 'block' : 'none',pointerEvents: activeMenu['listing']?.['grid-layout'] ? 'auto' : 'none', backgroundColor: 'white', boxShadow: '0 5px 30px rgba(0, 22, 84, 0.1)'}}>
                                    ...
                                    <li className={`${['/list-layout-with-map','/grid-layout-with-map','/classical-layout-with-map','/half-map','/half-map-2'].includes(current) ? 'active' : ''}`} onMouseEnter={() => handleMouseEnter('listing', 'map-layout')} onMouseLeave={() => handleMouseLeave('listing', 'map-layout')}><Link href="#" onClick={(e) => e.preventDefault()} style={{color: '#333'}}>With Map Property<FiChevronDown className="submenu-indicator"/></Link>
                                        <ul className="nav-dropdown nav-submenu" style={{display: activeMenu['listing']?.['map-layout'] ? 'block' : 'none',pointerEvents: activeMenu['listing']?.['map-layout'] ? 'auto' : 'none', backgroundColor: 'white', boxShadow: '0 5px 30px rgba(0, 22, 84, 0.1)'}}>
                            ...
                            <li className={`${['/single-property-1','/single-property-2','/single-property-3','/single-property-4','/agents','/agent-page','/add-agent','/edit-agent','/agencies','/agency-page','/dashboard','/create-account','/my-profile','/payment','/checkout','/my-property','/bookmark-list','change-password','/compare-property','/submit-property'].includes(current)?'active':''} ${activeMenu['feature']?.main ? 'show' : ''}`} onMouseEnter={() => handleMouseEnter('feature')} onMouseLeave={() => handleMouseLeave('feature')}>
                                <Link href="#" onClick={(e) => e.preventDefault()} style={{color: 'white', fontWeight: 'bold', textShadow: '1px 1px 3px rgba(0,0,0,0.5)'}}>Features<FiChevronDown className="submenu-indicator"/></Link>
                                <ul className="nav-dropdown nav-submenu" style={{display: activeMenu['feature']?.main ? 'block' : 'none', pointerEvents: activeMenu['feature']?.main ? 'auto' : 'none', backgroundColor: 'white', boxShadow: '0 5px 30px rgba(0, 22, 84, 0.1)'}}>
                                    <li className={['/single-property-1','/single-property-2','/single-property-3','/single-property-4'].includes(current)?'active':''} onMouseEnter={() => handleMouseEnter('listing', 'single-property')} onMouseLeave={() => handleMouseLeave('listing', 'single-property')}><Link href="#" onClick={(e) => e.preventDefault()} style={{color: '#333'}}>Single Property<FiChevronDown className="submenu-indicator"/></Link>
                                        <ul className="nav-dropdown nav-submenu" style={{display: activeMenu['listing']?.['single-property'] ? 'block' : 'none',pointerEvents: activeMenu['listing']?.['single-property'] ? 'auto' : 'none', backgroundColor: 'white', boxShadow: '0 5px 30px rgba(0, 22, 84, 0.1)'}}>
                                    ...
                                    <li className={['/agents','/agent-page','/add-agent'].includes(current)?'active':''} onMouseEnter={() => handleMouseEnter('listing', 'agent-list')} onMouseLeave={() => handleMouseLeave('listing', 'agent-list')}><Link href="#" onClick={(e) => e.preventDefault()} style={{color: '#333'}}>Agents<FiChevronDown className="submenu-indicator"/></Link>
                                        <ul className="nav-dropdown nav-submenu" style={{display: activeMenu['listing']?.['agent-list'] ? 'block' : 'none',pointerEvents: activeMenu['listing']?.['agent-list'] ? 'auto' : 'none', backgroundColor: 'white', boxShadow: '0 5px 30px rgba(0, 22, 84, 0.1)'}}>
                                    ...
                                    <li className={['/agencies','/agency-page'].includes(current)?'active':''} onMouseEnter={() => handleMouseEnter('listing', 'agency-list')} onMouseLeave={() => handleMouseLeave('listing', 'agency-list')}><Link href="#" onClick={(e) => e.preventDefault()} style={{color: '#333'}}>Agencies<FiChevronDown className="submenu-indicator"/></Link>
                                        <ul className="nav-dropdown nav-submenu" style={{display: activeMenu['listing']?.['agency-list'] ? 'block' : 'none',pointerEvents: activeMenu['listing']?.['agency-list'] ? 'auto' : 'none', backgroundColor: 'white', boxShadow: '0 5px 30px rgba(0, 22, 84, 0.1)'}}>
                                    ...
                                    <li className={['/dashboard','/create-account','/payment','/checkout','/my-profile','/my-property','/bookmark-list','/change-password'].includes(current)?'active':''} onMouseEnter={() => handleMouseEnter('listing', 'account')} onMouseLeave={() => handleMouseLeave('listing', 'account')}><Link href="#" style={{color: '#333'}}>My Account<FiChevronDown className="submenu-indicator"/></Link>
                                        <ul className="nav-dropdown nav-submenu" style={{display: activeMenu['listing']?.['account'] ? 'block' : 'none',pointerEvents: activeMenu['listing']?.['account'] ? 'auto' : 'none', backgroundColor: 'white', boxShadow: '0 5px 30px rgba(0, 22, 84, 0.1)'}}>
                                    ...
                                    <li>
                                        <Link href="/compare-property" className={current === '/compare-property' ? 'active' : ''} style={{color: '#333'}}>Compare Property</Link>
                                    </li>
                                    <li>
                                        <Link href="/submit-property" className={current === '/submit-property' ? 'active' : ''} style={{color: '#333'}}>Submit Property</Link>
                                    </li>
                                </ul>
                            </li>
                            <li className={`${['/about-us','/blog','/blog-detail','/component','/pricing','/faq','/404','/contact'].includes(current)?'active':''} ${activeMenu['pages']?.main ? 'show' : ''}`} onMouseEnter={() => handleMouseEnter('pages')} onMouseLeave={() => handleMouseLeave('pages')}>
                                <Link href="#" onClick={(e) => e.preventDefault()} style={{color: 'white', fontWeight: 'bold', textShadow: '1px 1px 3px rgba(0,0,0,0.5)'}}>Pages<FiChevronDown className="submenu-indicator"/></Link>
                                <ul className="nav-dropdown nav-submenu" style={{display: activeMenu['pages']?.main ? 'block' : 'none', pointerEvents: activeMenu['pages']?.main ? 'auto' : 'none', backgroundColor: 'white', boxShadow: '0 5px 30px rgba(0, 22, 84, 0.1)'}}>
                                    <li><Link href="/about-us" className={current === '/about-us' ? 'active' : ''} style={{color: '#333'}}>About Us</Link></li>
                                    <li><Link href="/blog" className={current === '/blog' ? 'active' : ''} style={{color: '#333'}}>Blogs Page</Link></li>
                                    <li><Link href="/blog-detail" className={current === '/blog-detail' ? 'active' : ''} style={{color: '#333'}}>Blog Detail</Link></li>
                                    <li><Link href="/component" className={current === '/component' ? 'active' : ''} style={{color: '#333'}}>Shortcodes</Link></li>
                                    <li><Link href="/pricing" className={current === '/pricing' ? 'active' : ''} style={{color: '#333'}}>Pricing</Link></li>
                                    <li><Link href="/faq" className={current === '/faq' ? 'active' : ''} style={{color: '#333'}}>Faq</Link></li>
                                    <li><Link href="/404" className={current === '/404' ? 'active' : ''} style={{color: '#333'}}>Error Page</Link></li>
                                    <li><Link href="/contact" className={current === '/contact' ? 'active' : ''} style={{color: '#333'}}>Contacts</Link></li>
                                </ul>
                            </li>
                        </ul>
        ...
        {/* Fixed white navbar - only visible when scrolled */}
        <div className="header header-fixed"
            style={{
                backgroundColor: 'white',
                boxShadow: '0 5px 30px rgba(0, 22, 84, 0.1)',
                transition: '0.3s',
                position: 'fixed',
                top: 0,
                left: 0,
            ...
            <div className="container">
                <nav id="navigation " className={windowWidth > 991 ? "navigation navigation-landscape" : "navigation navigation-portrait"}>
                    <div className="nav-header" style={{lineHeight:'0'}}>
                        <Link className="nav-brand text-logo" href="#">
                            <Image src='/img/logo-new.svg' width={50} height={50} alt="" />
                            <h5 className="fs-3 fw-bold ms-1 my-0" style={{color: scroll ? '#333' : 'white', textShadow: scroll ? 'none' : '1px 1px 3px rgba(0,0,0,0.5)'}}>HomeVista</h5>
                        </Link>
                        <div className="nav-toggle" onClick={()=>setIsToggle(!toggle)}></div>
                        <div className="mobile_nav">
                            <ul>
                    ...
                    <div className={`nav-menus-wrapper  ${toggle ? 'nav-menus-wrapper-open' : ''}`} style={{transitionProperty:toggle ? 'none' : 'left'}}>
                        <span className="nav-menus-wrapper-close-button" onClick={()=>setIsToggle(!toggle)}>✕</span>
                        <ul className="nav-menu" style={{color: scroll ? 'inherit' : 'white', fontWeight: 'bold'}}>

                            <li className={`${['/','/video','/map'].includes(current) ? 'active' : ''}`}>
                                <Link href="/" style={{color: scroll ? '#333' : 'white', fontWeight: 'bold', textShadow: scroll ? 'none' : '1px 1px 3px rgba(0,0,0,0.5)'}}>Home</Link>
                            </li>

                            <li className={` ${['/list-layout-one','/list-layout-two','/list-layout-three','/list-layout-with-map','/list-layout-full','/list-layout-one','/list-layout-two','/list-layout-three','/list-layout-with-map','/list-layout-full','/grid-layout-with-sidebar','/classical-layout-with-sidebar','/grid-layout-with-map','/grid','/classical-property','/list-layout-with-map','/grid-layout-with-map','/classical-layout-with-map','/half-map','/half-map-2'].includes(current) ? 'active' : ''} ${activeMenu['listing']?.main ? 'show' : ''}`} onMouseEnter={() => handleMouseEnter('listing')} onMouseLeave={() => handleMouseLeave('listing')}>
                                <Link href="#" onClick={(e) => e.preventDefault()} style={{color: scroll ? '#333' : 'white', fontWeight: 'bold', textShadow: scroll ? 'none' : '1px 1px 3px rgba(0,0,0,0.5)'}}>Listings<FiChevronDown className="submenu-indicator"/></Link>
                                <ul className="nav-dropdown nav-submenu" style={{display: activeMenu['listing']?.main ? 'block' : 'none', pointerEvents: activeMenu['listing']?.main ? 'auto' : 'none', backgroundColor: 'white', boxShadow: '0 5px 30px rgba(0, 22, 84, 0.1)'}}>
                                    <li className={`${['/list-layout-one','/list-layout-two','/list-layout-three','/list-layout-with-map','/list-layout-full'].includes(current) ? 'active' : ''}`} onMouseEnter={() => handleMouseEnter('listing', 'list-layout')} onMouseLeave={() => handleMouseLeave('listing', 'list-layout')}><Link href="#" onClick={(e) => e.preventDefault()} style={{color: '#333'}}>List Layout<FiChevronDown className="submenu-indicator"/></Link>
                                        <ul className="nav-dropdown nav-submenu" style={{display: activeMenu['listing']?.['list-layout'] ? 'block' : 'none',pointerEvents: activeMenu['listing']?.['list-layout'] ? 'auto' : 'none', backgroundColor: 'white', boxShadow: '0 5px 30px rgba(0, 22, 84, 0.1)'}}>
                                            <li><Link href="/list-layout-one" className={current === '/list-layout-one' ? 'active' : ''}>List Layout Simple</Link></li>
                                    ...
                                    <li className={`${['/grid-layout-with-sidebar','/classical-layout-with-sidebar','/grid-layout-with-map','/grid','/classical-property'].includes(current) ? 'active' : ''}`} onMouseEnter={() => handleMouseEnter('listing', 'grid-layout')} onMouseLeave={() => handleMouseLeave('listing', 'grid-layout')}><Link href="#" onClick={(e) => e.preventDefault()}>Grid Layout<FiChevronDown className="submenu-indicator"/></Link>
                                    ...
                                    <li className={`${['/list-layout-with-map','/grid-layout-with-map','/classical-layout-with-map','/half-map','/half-map-2'].includes(current) ? 'active' : ''}`} onMouseEnter={() => handleMouseEnter('listing', 'map-layout')} onMouseLeave={() => handleMouseLeave('listing', 'map-layout')}><Link href="#" onClick={(e) => e.preventDefault()}>With Map Property<FiChevronDown className="submenu-indicator"/></Link>
                            ...
                            <li className={`${['/single-property-1','/single-property-2','/single-property-3','/single-property-4','/agents','/agent-page','/add-agent','/edit-agent','/agencies','/agency-page','/dashboard','/create-account','/my-profile','/payment','/checkout','/my-property','/bookmark-list','change-password','/compare-property','/submit-property'].includes(current)?'active':''} ${activeMenu['feature']?.main ? 'show' : ''}`} onMouseEnter={() => handleMouseEnter('feature')} onMouseLeave={() => handleMouseLeave('feature')}>
                                <Link href="#" onClick={(e) => e.preventDefault()} style={{color: scroll ? '#333' : 'white', fontWeight: 'bold', textShadow: scroll ? 'none' : '1px 1px 3px rgba(0,0,0,0.5)'}}>Features<FiChevronDown className="submenu-indicator"/></Link>
                                <ul className="nav-dropdown nav-submenu" style={{display: activeMenu['feature']?.main ? 'block' : 'none', pointerEvents: activeMenu['feature']?.main ? 'auto' : 'none', backgroundColor: 'white', boxShadow: '0 5px 30px rgba(0, 22, 84, 0.1)'}}>
                                    <li className={['/single-property-1','/single-property-2','/single-property-3','/single-property-4'].includes(current)?'active':''} onMouseEnter={() => handleMouseEnter('listing', 'single-property')} onMouseLeave={() => handleMouseLeave('listing', 'single-property')}><Link href="#" onClick={(e) => e.preventDefault()}>Single Property<FiChevronDown className="submenu-indicator"/></Link>
                                    ...
                                    <li className={['/agents','/agent-page','/add-agent'].includes(current)?'active':''} onMouseEnter={() => handleMouseEnter('listing', 'agent-list')} onMouseLeave={() => handleMouseLeave('listing', 'agent-list')}><Link href="#" onClick={(e) => e.preventDefault()}>Agents<FiChevronDown className="submenu-indicator"/></Link>
                                    ...
                                    <li className={['/agencies','/agency-page'].includes(current)?'active':''} onMouseEnter={() => handleMouseEnter('listing', 'agency-list')} onMouseLeave={() => handleMouseLeave('listing', 'agency-list')}><Link href="#" onClick={(e) => e.preventDefault()}>Agencies<FiChevronDown className="submenu-indicator"/></Link>
                                    ...
                                    <li className={['/dashboard','/create-account','/payment','/checkout','/my-profile','/my-property','/bookmark-list','/change-password'].includes(current)?'active':''} onMouseEnter={() => handleMouseEnter('listing', 'account')} onMouseLeave={() => handleMouseLeave('listing', 'account')}><Link href="#" onClick={(e) => e.preventDefault()}>My Account<FiChevronDown className="submenu-indicator"/></Link>
                            ...
                            <li className={`${['/about-us','/blog','/blog-detail','/component','/pricing','/faq','/404','/contact'].includes(current)?'active':''} ${activeMenu['pages']?.main ? 'show' : ''}`} onMouseEnter={() => handleMouseEnter('pages')} onMouseLeave={() => handleMouseLeave('pages')}>
                                <Link href="#" onClick={(e) => e.preventDefault()} style={{color: scroll ? '#333' : 'white', fontWeight: 'bold', textShadow: scroll ? 'none' : '1px 1px 3px rgba(0,0,0,0.5)'}}>Pages<FiChevronDown className="submenu-indicator"/></Link>
                                <ul className="nav-dropdown nav-submenu" style={{display: activeMenu['pages']?.main ? 'block' : 'none', pointerEvents: activeMenu['pages']?.main ? 'auto' : 'none', backgroundColor: 'white', boxShadow: '0 5px 30px rgba(0, 22, 84, 0.1)'}}>
                        ...
                        <ul className="nav-menu nav-menu-social align-to-right d-none d-lg-inline-flex">
                            ...
                            <li>
                                <Link href="#" data-bs-toggle="modal" data-bs-target="#login"
                                      className="fw-medium"
                                      style={{color: scroll ? '#6c757d' : 'white'}}
                                      onClick={()=>setLogin(!login)}>
                                    <span className="svg-icon svg-icon-2hx me-1">
                                        <svg width="22" height="22" viewBox="0 0 18 18" fill="none" xmlns="http://www.w3.org/2000/svg">
                                            <path opacity="0.3" d="M16.5 9C16.5 13.125 13.125 16.5 9 16.5C4.875 16.5 1.5 13.125 1.5 9C1.5 4.875 4.875 1.5 9 1.5C13.125 1.5 16.5 4.875 16.5 9Z" fill="currentColor"/>
                    ...
                    <div className="modal-content" id="registermodal">
                        ...
                        <div className="modal-body">
                            ...
                            <div className="d-flex align-items-center justify-content-center mb-3">
                                <Image src='/img/logo-new.svg' width={80} height={80} alt="HomeVista Logo" className="mb-2" />
                            </div>
